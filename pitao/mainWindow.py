...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 0, 120, 181))
        ...
        self.btn_mostrar = QtGui.QPushButton(self.groupBox)
        self.btn_mostrar.setGeometry(QtCore.QRect(10, 90, 101, 23))
        self.btn_mostrar.setObjectName(_fromUtf8("btn_mostrar"))
        self.btn_salvar = QtGui.QPushButton(self.groupBox)
        self.btn_salvar.setGeometry(QtCore.QRect(10, 120, 101, 23))
        self.btn_salvar.setObjectName(_fromUtf8("btn_salvar"))
        self.btn_historico = QtGui.QPushButton(self.groupBox)
        self.btn_historico.setGeometry(QtCore.QRect(10, 150, 101, 23))
        self.btn_historico.setObjectName(_fromUtf8("btn_historico"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_mostrar.setText(_translate("MainWindow", "Mostrar Rota", None))
        self.btn_salvar.setText(_translate("MainWindow", "Salvar Rota", None))
        self.btn_historico.setText(_translate("MainWindow", "Histórico", None))
